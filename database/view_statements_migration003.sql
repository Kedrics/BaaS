CREATE VIEW User_Bots AS SELECT B.Bot_ID, B.OS, B.IP_Address FROM Bots B JOIN Interface I ON B.Interface_ID = I.Interface_ID JOIN User U ON I.User_ID = U.User_ID;
